...
export interface ApiChallengeChallenge extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    store_response: Schema.Attribute.Boolean;
    order: Schema.Attribute.Integer;
    timer_bonus: Schema.Attribute.Boolean;
    lesson: Schema.Attribute.Relation<'manyToOne', 'api::lesson.lesson'>;
    challenge_data: Schema.Attribute.DynamicZone<
      [
    ...
    appId: Schema.Attribute.BigInteger & Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiEmailingEmailing extends Struct.CollectionTypeSchema {
  collectionName: 'emailings';
  info: {
    singularName: 'emailing';
    pluralName: 'emailings';
      ...
      Schema.Attribute.CustomField<
        'global::remote-select',
        {
          fetch: {
            ...
            path: 'emails';
            token: 'E6Q43QuzzFTfdylXWBj9XYo0qlTZcGxFU5r5aLulGZ2sgw0IdPvrVrVcAaDxBzb3';
          };
        }
      >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    title: Schema.Attribute.String;
    order: Schema.Attribute.Integer;
    congrats_text: Schema.Attribute.String;
    congrats_avatar: Schema.Attribute.Media<
    ...
    >;
    live: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    appId: Schema.Attribute.BigInteger;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUnitUnit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order: Schema.Attribute.Integer;
    reveal_date: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::emailing.emailing': ApiEmailingEmailing;
